...
folder are mapped to the application's root namespace, 'IUC.admin'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'IUC.admin' in the same way
as `"IUC.admin/sass/src"`.
